    ...
    return (
      <div className="relative w-full">
        <div className="bg-gradient-to-br from-[#061F59] to-[#0A2A6B] rounded-3xl p-6 lg:p-8 shadow-2xl border border-[#FDCC29]/20 overflow-hidden relative min-h-[280px] lg:min-h-[350px] w-full ring-1 ring-[#FDCC29]/10">
          ...
          <div className="absolute top-2 left-4 w-12 h-12 bg-emerald-600/20 rounded-full blur-sm"></div>
          <div className="absolute top-2 right-4 w-12 h-12 bg-emerald-600/20 rounded-full blur-sm"></div>

          {/* Additional Decorative Elements */}
          <div className="absolute top-6 left-1/4 w-2 h-2 bg-emerald-600/40 rounded-full"></div>
          <div className="absolute top-12 right-1/3 w-1.5 h-1.5 bg-emerald-600/30 rounded-full"></div>
          <div className="absolute bottom-20 left-1/3 w-3 h-3 bg-emerald-600/25 rounded-full"></div>
          <div className="absolute bottom-16 right-1/4 w-2.5 h-2.5 bg-emerald-600/35 rounded-full"></div>

          {/* Subtle Grid Pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-0 left-0 w-full h-px bg-emerald-600"></div>
            <div className="absolute top-8 left-0 w-full h-px bg-emerald-600"></div>
            <div className="absolute top-16 left-0 w-full h-px bg-emerald-600"></div>
            <div className="absolute top-24 left-0 w-full h-px bg-emerald-600"></div>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-emerald-600 rounded-full flex items-center justify-center">
                  <Lightbulb className="w-4 h-4 sm:w-5 sm:h-5 text-slate-800" />
                </div>
                <span className="text-xl sm:text-2xl font-bold text-emerald-500">
                  IDEA
                </span>
            ...
            <Button
              ...
              className="bg-emerald-600 hover:bg-emerald-600/90 text-slate-800 px-8 py-4 text-base sm:text-lg font-bold rounded-xl shadow-xl transition-all duration-300 hover:scale-105 border-2 border-[#061F59]/20"
            >
              Earn My Icoins
      ...
      >
        ...
        {banners.length > 1 && (
          <>
            <button
              onClick={prevBanner}
              className="absolute left-3 top-1/2 transform -translate-y-1/2 bg-emerald-600/20 hover:bg-emerald-600/40 text-white p-2.5 rounded-full transition-all duration-300 z-20 backdrop-blur-sm border border-[#FDCC29]/30 hover:scale-110"
            >
              <ChevronLeft className="w-4 h-4" />
            </button>
            <button
              onClick={nextBanner}
              className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-emerald-600/20 hover:bg-emerald-600/40 text-white p-2.5 rounded-full transition-all duration-300 z-20 backdrop-blur-sm border border-[#FDCC29]/30 hover:scale-110"
            >
            ...
            {banners.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 hover:scale-125 ${
                  index === currentIndex
                    ? "bg-emerald-600 shadow-lg shadow-[#FDCC29]/50"
                    : "bg-emerald-600/60 hover:bg-emerald-600/80"
                }`}
              />
            ))}
          </div>
